...
<figure class="diagram-card diagram-wide">
  <img src="/blog/bug-surface-map.svg" alt="A simplified pipeline map showing the main failure zones: tokenizer, architecture, attention math, decode state, and logits." loading="lazy" />
  <figcaption>The failures were concentrated in a few specific zones: tokenization, model interpretation, attention math, decode state, and the final logits path.</figcaption>
</figure>
...
<figure class="diagram-card diagram-wide">
  <img src="/blog/correctness-before-speed.svg" alt="A simple five-step sequence showing architecture, state, numerics, reproducibility, and performance in that order." loading="lazy" />
  <figcaption>The order mattered more than the individual bugs: architecture first, then state, then numerics, then reproducibility, and only after that performance.</figcaption>
</figure>
