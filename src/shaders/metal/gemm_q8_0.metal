...
// Q8_0 GEMM kernel for prefill: quantized weight [M,K] x f32 input [N,K]
// -> f32 output [N,M]. The tile shape matches gemm_q4k/q6k and llama.cpp's
// mul_mm layout: 64 output rows x 32 tokens, 4 simdgroups, NK=32.
...
kernel void main0(
    ...
    device const block_q8_0 * x = (device const block_q8_0 *)(src0 + args.src0_off + args.nb01 * (r0 + lr0)) + offset1;
