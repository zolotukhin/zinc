...
// Large-M specialization for Gemma 4 31B dense projections with K=5376.
// It keeps the full 21 KiB input vector in threadgroup memory and reuses it
// across 16 rows per threadgroup.
#define TG_SIZE 512
