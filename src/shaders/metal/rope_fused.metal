...
kernel void main0(constant _23& _25 [[buffer(0)]], device _57& _59 [[buffer(1)]], device _102& _104 [[buffer(2)]], device const float* inv_freq [[buffer(3)]], uint3 gl_LocalInvocationID [[thread_position_in_threadgroup]], uint3 gl_WorkGroupID [[threadgroup_position_in_grid]])
{
    uint _37 = _25._m1 / 2u;
    ...
    for (uint _159 = gl_LocalInvocationID.x; _159 < _37; )
    {
        ...
        float _94 = float(_25._m3) * inv_freq[_159];
        float _97 = cos(_94);
        float _100 = sin(_94);
