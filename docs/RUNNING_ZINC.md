...
llama31-8b-q4k-m               2024-07-23   supported   yes    yes         yes      tested + exact fit
qwen3-8b-q4k-m                 2025-04-29   supported   yes    yes         no       tested + exact fit
```
...
./zig-out/bin/zinc model rm --force llama31-8b-q4k-m
```
