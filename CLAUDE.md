...
- Zig 0.15.2+ (host), MSL / Metal Shading Language (GPU shaders), Objective-C (thin shim) + Metal.framework, Foundation.framework, SPIRV-Cross (build tool), Xcode Command Line Tools (004-apple-silicon-inference)
- GGUF model files (mmap'd, zero-copy via `newBufferWithBytesNoCopy`) (004-apple-silicon-inference)
